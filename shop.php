                            ...
                            <div class="catagories-menu">
                                <ul id="menu-content2" class="menu-content collapse show">
                                    ...
                                    <li>
                                        ...
                                        <a href="shop.php?cat_name=<?php echo $cat_arr['category_name']?>">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    $sel_cat_prods  = "SELECT * FROM products WHERE category = '".$_GET['cat_name']."'";
                                    $run_sel        = mysqli_query($conn,$sel_cat_prods);
                                ...
                                ?>
                                    ...
                                    <div class="product-description">
                                        ...
                                        <input type="hidden"  name="brand_name" value="<?php echo $prod_arr['brand']?>">
                                            ...
                                            <input type="hidden" name="product_price" id="price" value="<?php echo $prod_arr['product_price']?>">
                                            <input type="hidden" name="pro_id" value="<?php echo $prod_arr['product_id']?>">
                                            <input type="hidden" name="quantity" id="" value="1">
                                            <input type="hidden" name="page_name" id=""  value="<?php echo $_SERVER['REQUEST_URI']?>">
                                            
                                            <!-- Hover Content -->
                                            <div class="hover-content">
                                            <!-- Add to Cart -->
                                            <div class="add-to-cart-btn">
                                                <button class="btn essence-btn" name="add_to_cart"   type="submit">Add to Cart</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    $sel_products   = "SELECT * FROM products WHERE brand LIKE '%$qry%' 
                                    OR product_name LIKE '%$qry%'
                                     OR
                                    product_price LIKE '%$qry%' OR 
                                    category LIKE '%$qry%' AND status = 1";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    $sel_products   = "SELECT * FROM products WHERE status = 1";
                                    $run_sel        = mysqli_query($conn,$sel_products);
