                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    $sel_products   = "SELECT * FROM products WHERE category = 'accessories'";
                    ...
                    ?>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                ...
                                <div class="single-product-wrapper">
                                    <!-- Product Image -->
                                    <a href="accessories_detail.php?prod_id=<?php echo $prod_arr['product_id']?>">
                                    <div class="product-img" style="height:50vh; display:flex; align-items:center;">
                                        ...
                                        ?>
                                        <img src="Admin_CP/product_images/<?php echo $img_arr['image_name']?>" style="width: 100%;" alt="">
                                    ...
                                    <div class="product-description">
                                        ...
                                        <div class="hover-content">
                                            ...
                                            <div class="add-to-cart-btn">
                                                <input type="submit" value="Add to Cart" name="add_to_cart" class="btn essence-btn"></button>
                                            </div>
                                        </div>
                                    </div>
                                    </a>
