...
<head>
    ...
    <!-- Title  -->
    <title>Essence - Fashion Ecommerce Store</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    $sel_products   = "SELECT * FROM sale_items WHERE status = 1";
                    ...
                    ?>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                ...
                                <div class="single-product-wrapper">
                                    <!-- Product Image -->
                                    <a href="sale_items_details.php?prod_id=<?php echo $prod_arr['product_id']?>">
                                    <div class="product-img" style="height:50vh; display:flex; align-items:center;">
                                        ...
                                        <div class="product-badge offer-badge">
                                            <span>-<?php echo $prod_arr['sale_percentage']?>%</span>
                                        </div>
                                        <!-- Favourite -->
                                ...
                                ?>
                                        ...
                                        <a href="manage_cart.php?prod_id=<?php echo $prod_arr['product_id']?> &prod_name=<?php echo $prod_arr['product_name']?>&prod_img=Admin_CP/product_images/<?php echo $img_arr['image_name']?>&price=<?php echo $prod_arr['new_price']?>&page_name=<?php echo $_SERVER['REQUEST_URI']?>"
                                    ...
                                    <div class="product-description">
                                        ...
                                        <input type="hidden" name="product_price" value="<?php echo $prod_arr['new_price']?>">
                                        ...
                                        <div class="hover-content">
                                            ...
                                            <div class="add-to-cart-btn">
                                                <button name="add_to_cart" type="submit" class="btn essence-btn">Add to Cart</button>
                        ...
                        else
                        {
                            ...
                            <h4 style = "color: gray; position: relative; margin-bottom:5vh top: 10vh; left:50vh">No sales available</h4>
