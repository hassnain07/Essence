...
if (isset($_POST['add_bg'])) {
  ...
  $insertslider = "INSERT INTO clothing_bg SET
                              bg_name   ='".$dir."/".$bg_img."'
                            "  ;
...
if (isset($_GET['action']) && $_GET['action']= 'delete_bg') {
  ...
  $delqry = "DELETE FROM clothing_bg WHERE bg_id ='".$bg_id."'
  ";
  ...
  if ($rundel) {
    ...
    header("Location:clothing_bg.php?okmsg=$okmsg");
    exit;
    }
    else {
      $errormsg = base64_encode("Background not deleted successfully");
      header("Location:clothing_bg.php?errormsg=$errormsg");
      exit;
    }
...
if (isset($_POST['update_bg'])) {
  ...
  $update_bg = 'UPDATE clothing_bg SET
                              bg_name ="'.$dir."/".$bg_img.'"
                              WHERE bg_id = "'.$bg_id.'"
                              ';
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            ...
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>Clothing Category Background</h1>
              </div>
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">clothing BG</li>
                </ol>
              </div>
            </div>
            <!-- add new product -->
                  ...
                  >
                    ...
                    <tbody>
                        ...
                        <?php
                          ...
                          $selectingslider = "SELECT * FROM clothing_bg";
                          $runsel          = mysqli_query($conn,$selectingslider);
                        ...
                        <td>
                          <a href="clothing_bg.php?bg_id=<?php echo $getting_bg['bg_id'];?>&amp;action=delete_bg"
