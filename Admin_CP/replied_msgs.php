...
if (isset($_GET['action']) && $_GET['action'] == 'deletemessage') {
  ...
  if ($rundel) {
    ...
    header("Location:replied_msgs.php?okmsg=$okmsg");
    exit;
    }
    else {
      $errormsg = base64_encode("Message not deleted successfully");
      header("Location:replied_msgs.php?errormsg=$errormsg");
      exit;
    }
                  ...
                  >
                    ...
                    <tbody>
                        ...
                        <?php
                          ...
                          $selectingmsg = "SELECT * FROM messages WHERE status = 2";
                        ...
                        <td>
                          <a href="replied_msgs.php?msg_id=<?php echo $gettingmessage['msg_id'];?>&amp;action=deletemessage"
