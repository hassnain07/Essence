              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Pending orders are shown here</h3>
                  </div>
                  ...
                  >
                    ...
                    <?php
                    $sel_orders = "SELECT * FROM billing_details WHERE status = 1";
                    ...
                    <table>
                        ...
                        <?php
                        // $sel_ordered_products  =  "SELECT * FROM order_details WHERE order_id = '".$order_arr['order_id']."' && status = 1";
                        ...
                        <tbody>
                          ...
                          <tr>
                            <?php 
                                     ...
                                     $total_price = mysqli_fetch_array($run_sel_prods);
                            ?>
                            

                            <td colspan = "3"><b>Total Price :</b><?php echo $total_price['total_price']?></td>
                          </tr>
                    ...
                    <td>
                        ...
                        <a href="orders.php?order_id=<?php echo $order_arr['order_id']?>&amp;action=delete_order" class="btn btn-danger btn-sm">Delete</a>
                        <br><br>
                        <form action="" method="post">
                        <button class="btn btn-primary btn-sm" name="update_status" >Mark Delivered</button>
